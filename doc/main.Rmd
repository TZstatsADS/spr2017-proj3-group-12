...
```{r}
image_test_dir <- "../data/test_data" # This will be modified for different data sets.
image_train_dir <- "../data/train_data/"
...
run.feature=TRUE # process features for all pictures
...
```{r train_label}
label_train <- read.csv(paste(image_train_dir, "labels.csv", sep=""),
                          header=T)
label_train <- as.numeric(unlist(label_train))
```
